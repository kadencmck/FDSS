          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
              ...
              <div className="space-y-5 mb-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-warm-gray">8528 W Elisa St, Boise, ID 83709</p>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="border-2 border-light-gray">
                <iframe
                  src="https://maps.google.com/maps?q=8528+W+Elisa+St%2C+Boise%2C+ID+83709&t=&z=14&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="450"
                  style={{ border: 0 }}
                  allowFullScreen
